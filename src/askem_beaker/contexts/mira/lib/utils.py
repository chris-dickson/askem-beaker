...
def start_chromadb(collection_name="examples", path="/home/jupyter/chromadb_functions"):
...
def query_docs(query, collection_name="documentation_index", path="/home/jupyter/chromadb_functions", n_results=5):
