...
def start_chromadb(docker=False, collection_name="examples", path="/home/jupyter/chromadb_functions"):
...
def add_examples(
    json_files: list = [
        '_media_hdd_Code_beaker-bio_src_beaker_bio_context_code_extracted_code_examples.json',
    ...
    for file in json_files:
        ...
        for example in examples:
            ...
            metadatas.append(
                {
                    'origination_method': example['origination_method'],
    ...
    u_query_collection = start_chromadb(collection_name="user_queries", path="/home/jupyter/chromadb_functions")
    ...
    examples_collection = start_chromadb(collection_name="examples", path="/home/jupyter/chromadb_functions")
