...
def start_chromadb(docker=False, collection_name="full", path="/home/jupyter/chromadb_functions"):
    import chromadb
...
class TextSplitter(ABC):
    ...
    def create_documents(self, texts: List[str], metadatas: Optional[List[dict]] = None) -> List[tuple]:
